                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-sm-offset-3">
                            <div class="pull-right">
                                <button type="button" class="btn btn-embossed btn-success m-r-20 btnRegistrar">Registrar
                                </button>
...
@push('Js')
    <script src="../assets/global/js/viewJs/Metodologia/RegistrarMetodologiaVista.js"></script>
@endpush