        ...
        <div class="page-header-content">
            <div class="page-title">
                ...
                <ul class="breadcrumb breadcrumb-caret position-right">
                    ...
                    <li class="active">Editar Metodologia</li>
                </ul>
            </div>
                ...
                <div class="panel panel-flat">
                    <div class="panel-body">
                        ...
                        <div class="text-right">
                            <button type="button" class="btn btn-success btnModificar">Modificar Metodologia <i
...
@push('Js')
    <script src="../viewJs/Metodologia/EditarMetodologiaVista.js"></script>
@endpush