    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Usuarios</span>
                </h4>
                ...
                <div class="panel-body">
                    <form id="frmNuevo" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group pos-rel">
                                    ...
                                    <input type="text" class="form-control" name="USUdni_usuario"
                                           id="txt_dni_usuario">
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group pos-rel">
                                    ...
                                    <select id="txt_tipo_usuario" name="USUtipo_usuario"
                                ...
                                {{--<div class="form-group pos-rel">--}}
                                    ...
                                    {{--<div class="input-group">--}}
                                        {{--<div class="icheck-inline">--}}
                                            {{--<label><input type="radio" name="reiniciar" data-radio="iradio_minimal-blue"--}}
                                                          {{--value="1"> Si</label>--}}
                                            {{--<label><input type="radio" name="reiniciar" checked--}}
                                                          {{--data-radio="iradio_minimal-blue" value="0"> No</label>--}}
                                        {{--</div>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                                <div class="form-group">
                                    <label class="display-block text-semibold">Resetear Contraseña</label>
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" name="radio-inline-left" value="0" checked class="styled">
                                        No
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn btn-success btnModificar">Modificar Usuario <i
...
@push('Js')
    <script src="../viewJs/Usuario/EditarUsuarioVista.js"></script>
@endpush